...
if ('gift' in localStorage) {
	newGift = false
	const giftName = localStorage.getItem('gift')
	gift = giftByName(giftName)
} else {
	newGift = true
	gift = randomGift()
	localStorage.setItem('gift', gift.name)
}

if (!newGift) {
	document.querySelector('.raspa').innerText = '¡Ya tenés tu don!'
}

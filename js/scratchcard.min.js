!(function (t, n) {
	...
	return (function (t) {
		...
		function (t, n, e) {
			...
			;(e(2).inspectSource = function (t) {
				...
				(t.exports = function (t, n, e, s) {
					...
					u && (i(e, 'name') || r(e, 'name', n)),
						t[n] !== e &&
							(u && (i(e, c) || r(e, c, t[n] ? '' + t[n] : a.join(String(n)))),
							t === o
								? (t[n] = e)
								: s
								? t[n]
			...
			;((n = t.exports = function (t, n, e, h, l) {
				...
				if (i(g)) {
					for (v = s(t.length); v > b; b++)
						if ((m = n ? y(c((p = t[b]))[0], p[1]) : y(t[b])) === u || m === f)
							return m
				} else
					for (d = g.call(t); !(p = d.next()).done; )
						if ((m = r(d, y, p.value, n)) === u || m === f) return m
			}).BREAK = u),
				(n.RETURN = f)
		},
		function (t, n, e) {
		...
		function (t, n, e) {
			...
			t.exports = function (t, n, e) {
				t &&
					!r((t = e ? t : t.prototype), i) &&
					o(t, i, {configurable: !0, value: n})
			}
		},
		function (t, n, e) {
			'use strict'
					...
					? function (t, n) {
							for (
								...
								for (
									var v,
										p = a(arguments[f++]),
										d = h ? r(p).concat(h(p)) : r(p),
										m = d.length,
										g = 0;
									m > g;

								)
									(v = d[g++]), (o && !l.call(p, v)) || (e[v] = p[v])
							return e
					  }
					: u
		},
		...
		function (t, n, e) {
			var o = e(14)
			o(o.P, 'Array', {fill: e(64)}), e(65)('fill')
		},
		function (t, n, e) {
			'use strict'
			var o = e(33),
			...
			var h = (function () {
				function t(n, e) {
					...
					;(this.config = Object.assign(Object.assign({}, s), e)),
						...
						this.config.scratchType === o.BRUSH &&
					...
					var h = f(function (t) {
						t.preventDefault(),
							...
							c.scratch(),
							r.config.enabledPercentUpdate && (c.percent = c.updatePercent())
					}, 16)
					this.canvas.addEventListener('mousedown', function (t) {
						t.preventDefault(),
							c._setScratchPosition(),
							c.scratchType === o.LINE &&
								((c.position = c.mousePosition(t)),
								c.brush.updateMousePosition(c.position[0], c.position[1]),
								...
								switch (t.type) {
									...
									case 'mousemove':
										;(n =
											...
											(e =
												t.clientY - this.config.clearZoneRadius - this.zone.top)
								}
								return [n, e]
							},
						},
